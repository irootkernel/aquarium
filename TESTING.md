...
- Last revalidated: 2026-08-22 after conservative inspector coverage for symlinked configuration and repository roots, exact neutral MCP diagnostics, pytest control-only settings, Make-valued shell aliases, and Delivery acknowledgement was added; the complete local gate passed with the same isolated unittest suites and no new integration boundary.
