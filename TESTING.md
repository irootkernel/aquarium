...
- Last revalidated: 2026-08-22 after conservative inspector coverage for fail-fast Make and framework commands, wrapped Make reverse edges, command-backed Rust and Dart runners, exact Gaori MCP arguments, and non-symlink paired skills was added; the complete local gate passed with the same isolated unittest suites and no new integration boundary.
