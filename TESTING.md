...
- Last revalidated: 2026-08-22 after conservative inspector coverage for executable Make calls, framework evidence, TESTING profile and manifest consistency, and legacy lockfiles was added; the complete local gate passed with the same isolated unittest suites and no new integration boundary.
