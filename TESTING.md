...
- Last revalidated: 2026-08-22 against functional candidate `e6f9c62fbdcb6210a78201f4a089f2349b33475f`. The complete local gate passed after converting `tests/test_inspect_testing.py` to native pytest fixtures and assertions and rechecking the remaining three isolated unittest suites, their temporary-repository and subprocess boundaries, the fixed Make runners, dependency pins, and the unchanged unittest major-version contract.
