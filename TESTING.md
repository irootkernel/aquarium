...
- Last revalidated: 2026-08-22 after conservative inspector coverage for sensitive-path exclusion, complete Make authority, resolved runner commands, absolute Make reverse edges, exact Ouroboros registration, and non-following symlink inspection was added; the complete local gate passed with the same isolated unittest suites and no new integration boundary.
