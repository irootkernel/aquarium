...
- Last revalidated: 2026-08-22 after layer-aware framework inspection and Gaori MCP binary-identity regression coverage were added; the complete local gate continued to pass with the same isolated unittest suites and no new integration boundary.
