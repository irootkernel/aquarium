...
- Last revalidated: 2026-08-22 after conservative inspector coverage for executable fail-fast Make calls, command-backed framework evidence, nonempty TESTING profiles and sections, manifest consistency, and legacy lockfiles was added; the complete local gate passed with the same isolated unittest suites and no new integration boundary.
