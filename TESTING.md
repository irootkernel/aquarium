...
- Last revalidated: 2026-08-22 against functional candidate `2a4f484c07ee41c9f3bd7a6594fcbb7c71df02d6`. The complete local gate passed with native pytest coverage for Ginkgo, Python configuration, runner-authority, and JSON boundaries plus waived unittest coverage for split-command Git routing, after rechecking the three isolated legacy suites, their temporary-repository and subprocess boundaries, the fixed Make runners, dependency pins, and the unchanged unittest major-version contract.
