...
- Last revalidated: 2026-08-22 after conservative inspector coverage for exact aggregate recipes, section-scoped enrollment, Make reverse edges, and command-backed Rust runners was added; the complete local gate passed with the same isolated unittest suites and no new integration boundary.
