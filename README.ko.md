...
- [Dolgorae](https://github.com/irootkernel/dolgorae)는 Profile이나 재사용 가능한 External Specialist Engagement처럼 명시적으로 요청한 native 작업에 쓰는 선택형 global 도구입니다. Aquarium은 공식 stable v0.1.x Apple Silicon 실행 파일 가운데 v0.1.2 이상을 검증해 진단하거나 설치할 수 있습니다. 다만 Aquarium Independent Review entrypoint는 일시적으로 비활성화되어 Dolgorae를 탐색·설정·실행하지 않습니다.
