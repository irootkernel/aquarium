...
- Let Task workflows select Mulgae, Orca, a fresh native Codex subagent, or an explicit delegated-review waiver while preserving route-specific evidence and bounded remediation.
