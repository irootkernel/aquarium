...
- `aquarium-design-v2` supports `new-project`, `new-feature`, `refactor`, and `design-qa` for one Git-backed design-document lifecycle. It records bounded context, discovery, draft, challenge, guarded phase-owner quality, explicit approval, application, assessment, and closeout. Ouroboros discovery and QA are leaf evidence; Aquarium retains repository authority.
