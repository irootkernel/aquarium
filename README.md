...
- [Dolgorae](https://github.com/irootkernel/dolgorae) remains an optional global tool for explicitly requested native operations such as Profiles and reusable External Specialist Engagements. Aquarium can diagnose and install verified official stable v0.1.x Apple Silicon releases starting at v0.1.2, but the Aquarium Independent Review entrypoint is temporarily disabled and does not discover, set up, or invoke Dolgorae.
