...
- [Dolgorae](https://github.com/irootkernel/dolgorae) supplies the exact immutable capture and checked review lifecycle used by Independent Review. Aquarium admits only the pinned official v0.1.0 Apple Silicon executable for that production review path.
