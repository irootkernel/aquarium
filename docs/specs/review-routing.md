...
the next authorized delegated review or waiver assessment. The existing bounded
rework policy still applies, including fresh user direction when its authority is
exhausted.
