...
Codex is Aquarium's primary workflow runtime. Aquarium integrates independently installed Orca, Podway, Sanho, Mulgae, Gaori, Ouroboros, Lora, Lore, and Deslop through explicit supported interfaces and version ranges where declared.
