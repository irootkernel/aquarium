...
Codex is Aquarium's primary workflow runtime. Aquarium integrates independently installed Dolgorae, Orca, Podway, Sanho, Mulgae, Gaori, Sorage, Ouroboros, Lora, Lore, Deslop, Humanizer, and im-not-ai through explicit supported interfaces and version ranges where declared.
